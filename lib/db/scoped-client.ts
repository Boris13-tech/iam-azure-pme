    ...
    query: {
      $allModels: {
        async $allOperations({ model, operation, args, query }) {
          const modelsWithTenant = ['Subject', 'IdentityAccount', 'Resource', 'Session', 'Entitlement', 'Assignment', 'AuthorizationShadowObservation', 'LocalIdentity', 'LocalAuthenticator', 'LocalAuthChallenge', 'LocalRecoveryCode', 'AuthenticationEvidence', 'CryptoKeyVersion', 'TrustAnchorVersion', 'IdentityContinuityState', 'OfflineIdentityChallenge', 'IdentityAssuranceSnapshot', 'IdentityContinuityEvent', 'IdentityContinuityConflict', 'IdentityPortabilityReceipt', 'IdentityRecoveryCeremony', 'IdentityRecoveryApproval', 'IdentityPortabilityConflict', 'CredentialReenrollmentRequirement'];
