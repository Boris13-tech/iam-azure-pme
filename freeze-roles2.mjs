...
c = c.replace(
  /export async function dualWriteCreateRole[\s\S]*?(?=export async function dualWriteUpdateRolePermissions)/,
...
c = c.replace(
  /export async function dualWriteUpdateRolePermissions[\s\S]*?(?=export async function dualWriteDeleteRole)/,
...
c = c.replace(
  /export async function dualWriteDeleteRole[\s\S]*?(?=async function syncNativeAssignmentsForUser)/,
